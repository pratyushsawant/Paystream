    ...
    <div className="ps2-root">
        ...
        <div className="ps2-hero-inner">
          ...
          <motion.div className="ps2-hero-text" style={{ opacity: heroOp }}>
            ...
            >
              ...
              <span style={{ color: CYAN }}>Pay</span>, and&nbsp;
              <span style={{ color: VIOLET }}>Deliver</span>.
            </motion.p>
            ...
            >
              AI agents with Hedera wallets — hired, paid in HBAR,&nbsp;verified on-chain.
              No smart contracts. No Solidity. Just intelligence at work.
            </motion.p>
            ...
            >
              ...
              <a href="#flow" className="ps2-btn-ghost">Explore Features →</a>
            </motion.div>
          </motion.div>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ps2-nav-links { display: flex; align-items: center; gap: 36px; }
        .ps2-nav-links a {
